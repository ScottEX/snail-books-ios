...
- [x] **09782b6** — 分红派发日 + 备注格式 ✅ 已在 6/24 迁移时完成，补充 handleDividend date
- [x] **fa1f0f0** — 徽标/统计字号 + 颜色 #1EE69F + 分红弹窗 ✅ 已在 6/24 迁移时完成
- [x] **dcf1159** — i18n 文案 + 删除弹窗主题 + 日期补零 ✅ 已在 6/24 迁移时完成
- [x] **32a3914** — partner 屏日期显示 ✅ 已在 6/24 迁移时完成
- [x] **600b2e2** — 分红/投资日期 i18n ✅ 已在 6/24 迁移时完成
- [x] **a7240a6** — translateDividendNote 从 dividend record 读日期 ✅ 已在 6/24 迁移时完成
- [x] **2e62855** — 合伙人卡片:日期显示 + 出资完成加绿 + 弹窗加宽 ✅ 已在 6/24 迁移时完成
- [x] **094a0c6** — 忘记密码→重置页去掉绿色成功消息 ✅ L468 已同步
