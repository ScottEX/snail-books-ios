      ...
      <CustomActionSheet
        ...
        actions={[
          ...
          },
          {
            ...
            icon: (
              <Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
                <Path d="M7 2h10l2 3h3a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3z" />
          ...
          },
          {
            ...
            icon: (
              <Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
                <Path d="M5 4h3v3H3V6a2 2 0 0 1 2-2z" />
                <Path d="M3 7h18a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z" />
              </Svg>
            ),
