...
// saturate(220%) blur(30px) capsule).
  ...
  revNoteInput: { backgroundColor: colors.surface, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: FONTS.sub.size, color: colors.textSub, marginBottom: 14 },
