...
export default function ExpenseDetailScreen({ expense, onBack, onEdited, onDeleted }: Props) {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      {/* Body */}
      <ScrollView style={[styles.body, { marginTop: 106 }]} contentContainerStyle={styles.bodyContent} showsVerticalScrollIndicator={false} keyboardDismissMode="interactive">
        {/* ── View mode ── */}
        {!editMode && (
          <View>
            {/* Amount card */}
...
const getStyles = (c: ThemeColors) =>
  StyleSheet.create({
    ...
    bodyContent: { paddingHorizontal: 16, paddingTop: 6, paddingBottom: 24 },
